...
public class Inicio extends JFrame {
	...
	public Inicio() {
		...
		lblNewLabel_2.setIcon(new ImageIcon(Inicio.class.getResource("/Imagenes/codigo-binario (1).png")));
		PanelMenu.add(lblNewLabel_2);
		
		JLabel lblNewLabel_10 = new JLabel("");
		lblNewLabel_10.setIcon(new ImageIcon(Inicio.class.getResource("/Imagenes/circulo (1).png")));
		lblNewLabel_10.setBounds(191, 0, 182, 255);
		PanelMenu.add(lblNewLabel_10);
		
		JLabel lblNewLabel_9 = new JLabel("");
		lblNewLabel_9.setIcon(new ImageIcon(Inicio.class.getResource("/Imagenes/blue-gradient-background.jpg")));
		...
		lblNewLabel_12.setIcon(new ImageIcon(Inicio.class.getResource("/Imagenes/forma-cuadrada-negra-redondeada.png")));
		lblNewLabel_12.setBounds(100, 54, 136, 124);
		PanelDecimal.add(lblNewLabel_12);
		
		JButton btnNewButton = new JButton("");
		btnNewButton.setIcon(new ImageIcon(Inicio.class.getResource("/Imagenes/regreso.png")));
		btnNewButton.setBounds(275, 202, 55, 41);
		PanelDecimal.add(btnNewButton);
		
		JLabel lblNewLabel_11 = new JLabel("");
		lblNewLabel_11.setIcon(new ImageIcon(Inicio.class.getResource("/Imagenes/blue-gradient-background.jpg")));
		...
		JLabel lblHexadecimalABinario = new JLabel("HEXADECIMAL A BINARIO");
		...
		btnCalHB.setBounds(118, 193, 89, 23);
		...
		lblNewLabel_14.setIcon(new ImageIcon(Inicio.class.getResource("/Imagenes/forma-cuadrada-negra-redondeada.png")));
		lblNewLabel_14.setBounds(95, 49, 128, 128);
		PanelHD.add(lblNewLabel_14);
		
		JButton btnRegreso_1 = new JButton("");
		btnRegreso_1.setIcon(new ImageIcon(Inicio.class.getResource("/Imagenes/regreso.png")));
		...
		lblNewLabel_13.setIcon(new ImageIcon(Inicio.class.getResource("/Imagenes/blue-gradient-background.jpg")));
		...
		JLabel lblOctalABinario = new JLabel("OCTAL A BINARIO");
		...
		btnRegreso.setIcon(new ImageIcon(Inicio.class.getResource("/Imagenes/regreso.png")));
		btnRegreso.setBounds(275, 216, 55, 35);
		PanelOctal.add(btnRegreso);
		
		JLabel lblNewLabel_16 = new JLabel("");
		lblNewLabel_16.setIcon(new ImageIcon(Inicio.class.getResource("/Imagenes/forma-cuadrada-negra-redondeada.png")));
		lblNewLabel_16.setBounds(110, 35, 142, 149);
		PanelOctal.add(lblNewLabel_16);
		
		JLabel lblNewLabel_15 = new JLabel("");
		lblNewLabel_15.setIcon(new ImageIcon(Inicio.class.getResource("/Imagenes/blue-gradient-background.jpg")));
		lblNewLabel_15.setBounds(0, 0, 340, 258);
		PanelOctal.add(lblNewLabel_15);
		
		//////////////////////////Escuchadores de los botones del menu///////////////////////////
		...
		btnCalDB.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				DecimalBinario op = new DecimalBinario();
				op.opDB(a);
		...
		btnCalHB.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				HexadecimalBinario op = new HexadecimalBinario();
				op.opDHD(a);
		...
		btnCalOB.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				OctalBinario op = new OctalBinario();
				op.opDO(a);
